                ...
                <div className="container relative text-center">
                    <div className="grid lg:grid-cols-12 md:grid-cols-3 grid-cols-1 items-center">
                        ...
                        <div className="lg:col-span-5 text-center mt-6 md:mt-0">
                            <p className="mb-0">© {new Date().getFullYear()} Hecho por Silingcorp <i className="mdi mdi-heart text-red-600"></i></p>
                        </div>
                        ...
                        <ul className="lg:col-span-4 list-none md:text-end text-center mt-6 md:mt-0">
                            ...
                            <li className="inline"><Link to="mailto:support@silingcorp.com.pe" className="size-8 inline-flex justify-center items-center border border-gray-800 rounded-md hover:border-teal-500 dark:hover:border-teal-500 hover:bg-teal-500 dark:hover:bg-teal-500"><FiMail className="size-4 align-middle" title="email"/></Link></li>
                        </ul>
                    </div>
                </div>
            </div>

                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-6">
                    ...
                    <div className="md:col-span-6">
                        <div className="lg:ms-8">
                            ...
                            <h3 className="font-semibold text-2xl leading-normal mb-4">Somos una empresa de tecnología global que brinda soluciones de software y servicios de desarrollo de aplicaciones móviles.</h3>
